...
<title>Deposit - PocketWallet</title>
<style>
*{box-sizing:border-box;font-family:system-ui,sans-serif;margin:0;padding:0;}
body{background:linear-gradient(160deg,#0f172a,#1e40af);min-height:100vh;display:flex;justify-content:center;align-items:center;padding:16px;}
...
<div class="container">
    <div class="card">
        ...
        <form method="POST" action="{{ route('deposit.store') }}">
            ...
            <input type="text" name="code" id="code" placeholder="Enter code from agent" required>
